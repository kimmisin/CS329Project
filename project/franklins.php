...
print<<<page
			...
			<div class = "bigPic">
				<img src = "franklins1.jpg" id = "big" alt="Image of Franklins" height = "400" width = "700">
			</div>
			<div class = "smallPic">
				<img src = "franklins2.jpg" id = "small1" alt="Image of Franklins" height = "100" width = "150" onclick = "changeImage(event)">
			</div>
			<div class = "smallPic">
				<img src = "franklins3.jpg" id = "small2" alt="Image of Franklins" height = "100" width = "150" onclick = "changeImage(event)">
			</div>
			<div class = "smallPic">
				<img src = "franklins4.jpg" id = "small3" alt="Image of Franklins" height = "100" width = "150" onclick = "changeImage(event)">
			</div>
			<div class = "text">
		    ...
		    <input type = 'hidden' name = 'link' value = 'franklins.php'/>
			<input type = 'hidden' name = 'title' value = "Franklin's BBQ"/>
                                <input type = 'hidden' name = 'image' value = 'franklins1.jpg'/>
