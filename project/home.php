...
print<<<page
	...
	<div id = "container">
		...
		<div id = "content">
			...
			<div class  = "slideshow">
				<a class = "slidelink" id = "slidelink" href = "franklins.php"><img class = "slideimage" id= "slideimage" src = "franklins1.jpg" alt = "franklins" width = "500" height = "300">
					<br><a class = "readmore" href = "franklins.php" id=slidecaption >Franklins BBQ</a></a>
                        </div>
			
			<div class = "smallPic">
				<a href = "mayfield.php"><img src = "https://assets.simpleviewinc.com/simpleview/image/fetch/c_fill,h_362,q_75,w_545/https://assets.simpleviewinc.com/simpleview/image/upload/crm/austin/011-59d14229c0b1cb6_59d14302-fcb3-c720-9ce131a92a6973d4.jpg" alt = "Mayfield Park and Preserve" width = "300" height = "200"></a>
				<div class = "text">
			...
			<div class = "smallPic">
				<a href = "zilker.php"><img src = "https://www.tripsavvy.com/thmb/nMZ2mxnD4iYiDdjBv7I_zdvUhf4=/3924x2207/smart/filters:no_upscale()/GettyImages-500491816-5a830da3c6733500377bd4e4.jpg" alt = "Zilker Park" width = "300" height = "200"></a>
				<div class = "text">
					<h3> Zilker Park </h3>
			...
			<div class = "smallPic">
				<a href = "waterloo.php"><img src = "https://assets.simpleviewinc.com/simpleview/image/fetch/c_fill,h_396,q_75,w_704/https://assets.simpleviewinc.com/simpleview/image/upload/crm/austin/WATERLOO-1-e051636c052bc64_e05164b2-b104-67f5-b39afc9b117be7a7.jpg" alt = "Lake Travis Waterloo Adventures" width = "300" height = "200"></a>
				<div class = "text">
			...
			<div class = "smallPic">
				<a href = "mckinney.php"><img src = "https://tpwd.texas.gov/state-parks/mckinney-falls/gallery/lower-mckinney-falls.jpg" alt = "McKinney Falls State Park" width = "300" height = "200"></a>
				<div class = "text">
		...
		<div id = "footer">
			Braden Wu | Brinnah Welmaker | Last Updated: 04/19/2021
		</div>
