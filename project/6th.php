...
print<<<page
	<div id = "container">
		...
		<div id = "content">
			<h1> 6th Street </h1>
			<div class = "bigPic">
				<img src = "sixth1.jpg" id = "big" height = "400" width = "700">
			</div>
			<div class = "smallPic">
				<img src = "sixth2.jpg" id = "small1" height = "100" width = "150" onclick = "changeImage(event)">
			</div>
			<div class = "smallPic">
				<img src = "sixth3.jpg" id = "small2" height = "100" width = "150" onclick = "changeImage(event)">
			</div>
			<div class = "smallPic">
				<img src = "sixth4.jpg" id = "small3" height = "100" width = "150" onclick = "changeImage(event)">
			</div>
			<div class = "text">
		...
		<div id = "footer">
			Braden Wu | Last Updated: 04/19/2021
		</div>
	</div>
